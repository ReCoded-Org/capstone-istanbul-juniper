          ...
          <div style={{background:"#3b8c79", height:"15vh"}}>
            <div className="navbarTopHalf" style={{height:"50%"}}>
              ...
              <ul className="navbarLeftSide">
                ...
                <li> <Link to="/games">{t('navbar.games')}</Link> </li>
              </ul>
              <Link to="/">
              <h1 className="navbarTitle">Juniper</h1>
              </Link>
              <ul className="navbarRightSide">
                <li> <Link to="/resources">{t('navbar.resources')}</Link> </li>
                <li> <Link to="/contact">{t('navbar.contact')}</Link> </li>
                <li> <Link to="/login">{t('navbar.login')}</Link> </li>
              </ul>
              <Link className="navbarLogoLink" to={"/"}>
              <img className="navbarLogo" src={require("./../../images/logo.svg")} alt="juniper-logo"/>
            </Link>
            </div>

            <div className="navbarBottomHalf" style={{background:"#b4d0c4",borderRadius:"50% 50% 0 0", height:"50%"}}>
              <div style={{height:"50%"}}>
              </div>
